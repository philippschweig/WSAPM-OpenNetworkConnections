...
namespace de.efsdev.DotNetExtensionLibrary.CustomMarshal
{
    ...
    public class ArrayMarshaler<T> : ICustomMarshaler
    {
        ...
        public Object MarshalNativeToManaged(IntPtr pNativeData)
        {
            ...
            int elSiz = Marshal.SizeOf(typeof(T));
            // Populate the array
            for (int i = 0; i < length; i++)
            {
                array[i] = (T)Marshal.PtrToStructure(new IntPtr(pNativeData.ToInt64() + sizeof(int) + (elSiz * i)), typeof(T));
            }
        ...
        {
            return sizeof(int) + Marshal.SizeOf(typeof(T));
        }
    }
}
